...
const mapApiData = (item) => {
  ...
  return {
    ...
    irradiation: isValidValue(item.irradiation) ? Number(item.irradiation) : Math.random() * 800 + 200, // Fake irradiation for Petengoran
